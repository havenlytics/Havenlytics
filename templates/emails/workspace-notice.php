<?php
/**
 * Workspace account notice email — registration, approval, invitation, password.
 *
 ...
 * Override at {theme}/havenlytics/emails/workspace-notice.php, or point an individual email
