<?php
/**
 * About your registration — Workspace registration lifecycle email.
 *
...
$hvnly_cta   = false && isset( $workspace_url ) ? (string) $workspace_url : '';

$hvnly_vars = array(
	'title'             => isset( $title ) ? (string) $title : __( 'About your registration', 'havenlytics' ),
	...
	'cta_label'         => isset( $cta_label ) ? (string) $cta_label : __( 'Contact support', 'havenlytics' ),
