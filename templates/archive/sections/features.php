 ...
 * 
 * This template displays the features for a property.
 * 
 * HOW TO OVERRIDE THIS TEMPLATE:
 * 1. Copy this file from: wp-content/plugins/havenlytics/templates/archive/sections/features.php
 * 2. Paste it to your theme at: wp-content/themes/your-theme/havenlytics/archive/sections/features.php
 * 3. Modify the copied file to customize the features display
 * 
 * @package     Havenlytics
...
<div class="hvnly-property-field-features hvnly-property-field-mode-<?php echo esc_attr( $hvnly_mode ); ?>">
    <div class="hvnly-property--grid-list--features">
        ...
        if ( $hvnly_mode === 'preset' && ! empty( $hvnly_section['fields'] ) ) {
            ...
            // Default mode: show all features in fixed order.
