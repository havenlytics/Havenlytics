...
<div class="hvnly-property-field-faq-count hvnly-property-contact-info-mode-<?php echo esc_attr( $hvnly_mode ); ?>">
	...
	<span class="hvnly-property-faq-count-text"><?php echo function_exists( 'hvnly_translate_ui' ) ? esc_html( hvnly_translate_ui( $hvnly_label ) ) : esc_html( $hvnly_label ); ?></span>
</div>
