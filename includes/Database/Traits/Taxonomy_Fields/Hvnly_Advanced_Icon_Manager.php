...
trait Hvnly_Advanced_Icon_Manager {
    ...
    public function hvnly_initialize_icon_manager( $taxonomy_slug ) {
        ...
        add_filter( "manage_edit-{$taxonomy_slug}_columns", [ $this, 'hvnly_add_icon_admin_column' ] );
        add_filter( "manage_{$taxonomy_slug}_custom_column", [ $this, 'hvnly_display_icon_admin_column' ], 10, 3 );
    }
    ...
    private function hvnly_register_icon_manager_hooks() {
        ...
        // Form field hooks
        add_action( "{$slug}_add_form_fields", [ $this, 'hvnly_render_icon_selection_field' ] );
        add_action( "{$slug}_edit_form_fields", [ $this, 'hvnly_render_icon_editing_field' ] );
        
        // Data persistence hooks
        add_action( "created_{$slug}", [ $this, 'hvnly_persist_icon_selection' ] );
        add_action( "edited_{$slug}", [ $this, 'hvnly_update_icon_selection' ] );
        
        // Asset management hooks
        add_action( 'admin_enqueue_scripts', [ $this, 'hvnly_enqueue_icon_assets' ] );
        
        // AJAX handlers
        add_action( 'wp_ajax_hvnly_get_icon_library', [ $this, 'hvnly_handle_icon_library_request' ] );
        add_action( 'wp_ajax_hvnly_search_icons', [ $this, 'hvnly_handle_icon_search_request' ] );
        
        // Background color field hooks
        add_action( "{$slug}_add_form_fields", [ $this, 'hvnly_render_background_color_field' ] );
        add_action( "{$slug}_edit_form_fields", [ $this, 'hvnly_render_background_color_editing_field' ] );
        add_action( "created_{$slug}", [ $this, 'hvnly_persist_background_color' ] );
        add_action( "edited_{$slug}", [ $this, 'hvnly_update_background_color' ] );
        
        // Display option field hooks
        add_action( "{$slug}_add_form_fields", [ $this, 'hvnly_render_display_option_field' ] );
        add_action( "{$slug}_edit_form_fields", [ $this, 'hvnly_render_display_option_editing_field' ] );
        add_action( "created_{$slug}", [ $this, 'hvnly_persist_display_option' ] );
        add_action( "edited_{$slug}", [ $this, 'hvnly_update_display_option' ] );
    }
    ...
    private function hvnly_retrieve_icon_data( $term_id ) {
        ...
        return is_array( $icon_data ) ? $icon_data : [];
    }
    ...
    private function hvnly_parse_font_awesome_json( $icons_data ) {
        ...
        foreach ( $icons_data as $style => $style_data ) {
            ...
            foreach ( $style_data['icons'] as $icon_name ) {
                ...
                $display_name = ucwords( str_replace( [ '-', '_' ], ' ', $icon_name ) );
    ...
    private function hvnly_get_fallback_font_awesome_icons() {
        return [
            [ 'name' => 'Star', 'class' => 'fas fa-star', 'style' => 'solid' ],
            [ 'name' => 'Heart', 'class' => 'fas fa-heart', 'style' => 'solid' ],
            [ 'name' => 'Home', 'class' => 'fas fa-home', 'style' => 'solid' ],
            [ 'name' => 'Building', 'class' => 'fas fa-building', 'style' => 'solid' ],
            [ 'name' => 'Tag', 'class' => 'fas fa-tag', 'style' => 'solid' ],
            [ 'name' => 'Award', 'class' => 'fas fa-award', 'style' => 'solid' ],
            [ 'name' => 'Certificate', 'class' => 'fas fa-certificate', 'style' => 'solid' ],
            [ 'name' => 'Crown', 'class' => 'fas fa-crown', 'style' => 'solid' ],
            [ 'name' => 'Gem', 'class' => 'fas fa-gem', 'style' => 'solid' ],
            [ 'name' => 'Fire', 'class' => 'fas fa-fire', 'style' => 'solid' ],
            [ 'name' => 'Bolt', 'class' => 'fas fa-bolt', 'style' => 'solid' ],
            [ 'name' => 'Flag', 'class' => 'fas fa-flag', 'style' => 'solid' ],
            [ 'name' => 'Check Circle', 'class' => 'fas fa-check-circle', 'style' => 'solid' ],
            [ 'name' => 'Exclamation Circle', 'class' => 'fas fa-exclamation-circle', 'style' => 'solid' ],
            [ 'name' => 'Info Circle', 'class' => 'fas fa-info-circle', 'style' => 'solid' ],
            [ 'name' => 'Trophy', 'class' => 'fas fa-trophy', 'style' => 'solid' ],
            [ 'name' => 'Medal', 'class' => 'fas fa-medal', 'style' => 'solid' ],
            [ 'name' => 'Shield Alt', 'class' => 'fas fa-shield-alt', 'style' => 'solid' ],
            [ 'name' => 'Umbrella Beach', 'class' => 'fas fa-umbrella-beach', 'style' => 'solid' ],
            [ 'name' => 'Mountain', 'class' => 'fas fa-mountain', 'style' => 'solid' ],
            [ 'name' => 'Tree', 'class' => 'fas fa-tree', 'style' => 'solid' ],
            [ 'name' => 'Sun', 'class' => 'fas fa-sun', 'style' => 'solid' ],
            [ 'name' => 'Snowflake', 'class' => 'fas fa-snowflake', 'style' => 'solid' ],
            [ 'name' => 'Cloud', 'class' => 'fas fa-cloud', 'style' => 'solid' ],
            [ 'name' => 'Car', 'class' => 'fas fa-car', 'style' => 'solid' ],
            [ 'name' => 'Key', 'class' => 'fas fa-key', 'style' => 'solid' ],
            [ 'name' => 'Bed', 'class' => 'fas fa-bed', 'style' => 'solid' ],
            [ 'name' => 'Bath', 'class' => 'fas fa-bath', 'style' => 'solid' ],
            [ 'name' => 'Ruler Combined', 'class' => 'fas fa-ruler-combined', 'style' => 'solid' ],
            [ 'name' => 'Wifi', 'class' => 'fas fa-wifi', 'style' => 'solid' ],
            [ 'name' => 'Swimming Pool', 'class' => 'fas fa-swimming-pool', 'style' => 'solid' ],
            [ 'name' => 'TV', 'class' => 'fas fa-tv', 'style' => 'solid' ],
            [ 'name' => 'Utensils', 'class' => 'fas fa-utensils', 'style' => 'solid' ],
            [ 'name' => 'Parking', 'class' => 'fas fa-parking', 'style' => 'solid' ],
            [ 'name' => 'Dog', 'class' => 'fas fa-dog', 'style' => 'solid' ],
            [ 'name' => 'Cat', 'class' => 'fas fa-cat', 'style' => 'solid' ],
            [ 'name' => 'User', 'class' => 'fas fa-user', 'style' => 'solid' ],
            [ 'name' => 'Users', 'class' => 'fas fa-users', 'style' => 'solid' ],
            [ 'name' => 'Phone', 'class' => 'fas fa-phone', 'style' => 'solid' ],
            [ 'name' => 'Envelope', 'class' => 'fas fa-envelope', 'style' => 'solid' ],
            [ 'name' => 'Map Marker Alt', 'class' => 'fas fa-map-marker-alt', 'style' => 'solid' ],
            [ 'name' => 'Calendar Alt', 'class' => 'fas fa-calendar-alt', 'style' => 'solid' ],
            [ 'name' => 'Clock', 'class' => 'fas fa-clock', 'style' => 'solid' ],
            [ 'name' => 'Dollar Sign', 'class' => 'fas fa-dollar-sign', 'style' => 'solid' ],
            [ 'name' => 'Euro Sign', 'class' => 'fas fa-euro-sign', 'style' => 'solid' ],
            [ 'name' => 'Pound Sign', 'class' => 'fas fa-pound-sign', 'style' => 'solid' ],
            [ 'name' => 'Chart Line', 'class' => 'fas fa-chart-line', 'style' => 'solid' ],
            [ 'name' => 'Shopping Bag', 'class' => 'fas fa-shopping-bag', 'style' => 'solid' ],
            [ 'name' => 'Gift', 'class' => 'fas fa-gift', 'style' => 'solid' ],
            [ 'name' => 'Camera', 'class' => 'fas fa-camera', 'style' => 'solid' ],
        ];
    }
