...
class Database
{
    ...
    public static function get_services(): array
    {
         ...
         */
        $services = apply_filters('hvnly_database_services', [
            ...
            [
                ...
                'singleton' => true,
                'method' => 'get_instance',
                'dependencies' => [Custom_Posts\HavenlyticsNab::class],
            ],
    ...
    public static function register_services(): void
    {
        ...
        foreach ($services as $service_config) {
            ...
            self::$dependencies[$class] = $service_config['dependencies'] ?? [];
     ...
     */
    private static function instantiate(string $class, array $config = [])
    {
        ...
        // Check dependencies
        $dependencies = $config['dependencies'] ?? self::$dependencies[$class] ?? [];
        ...
        try {
            ...
            if (isset($config['singleton']) && $config['singleton']) {
                ...
                if (method_exists($class, $method)) {
                    $service = call_user_func([$class, $method]);
