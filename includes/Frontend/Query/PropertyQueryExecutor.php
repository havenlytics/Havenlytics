...
class PropertyQueryExecutor {
     ...
     */
    private static $hvnly_request_queries = array();
     ...
     * @return \WP_Query
     */
    public static function query( array $hvnly_data, int $hvnly_page = 1, int $hvnly_per_page = 12, array $hvnly_options = array() ): \WP_Query {
        $hvnly_options = wp_parse_args($hvnly_options, array(
            'widget_id'      => '',
            'filter_context' => 'default',
            'bypass_cache'   => false,
        ));

        $hvnly_build_options = array();
     ...
     * @return array
     */
    public static function build_args( array $hvnly_data, int $hvnly_page = 1, int $hvnly_per_page = 12, array $hvnly_options = array() ): array {
        $hvnly_build_options = array();
