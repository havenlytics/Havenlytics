...
class LegacyCompatibility {
    ...
    public function __construct() {
        ...
        add_action('init', [$this, 'register_legacy_shortcodes'], 20);
        
        // Handle legacy attribute conversions
        add_filter('hvnly_shortcode_legacy_atts', [$this, 'convert_legacy_attributes'], 10, 2);
    }
    ...
    public function convert_legacy_attributes($atts, $shortcode) {
        ...
        foreach ($atts as $key => $value) {
            ...
            if ($new_key === 'featured_only') {
                ...
                $value = in_array(strtolower($value), ['true', '1', 'yes'], true) ? 'yes' : 'no';
            }
